...
<div
    ...
    <div class="container-fluid">
        <div class="col-3">
            <a href="{{ route('store-feeds') }}" class="btn btn-secondary">
                Refresh Database
            </a>
        </div>
        ...
        <div class="col-7">
                    ...
                    <main class="p-6 py-6 px-4 sm:p-6 md:py-10 md:px-8">
                        <div class="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
                            ...
                            <dl class="mt-4 text-xs font-medium flex items-center row-start-2 sm:mt-1 sm:row-start-3 md:mt-2.5 lg:row-start-2">
                                <dt class="sr-only">Publish at:</dt>
            ...
            @empty
                <div class="p-4 mb-4 text-sm text-blue-700 bg-blue bg-gray-100" role="alert">
                    <span class="font-medium">Oops!</span> News Feeds not available.
                </div>
            @endforelse
        </div>
